  ...
  if (captureAudio) {
    if (Platform.OS === 'ios') {
      hasRecordAudioPermissions =
        await CameraManager.checkRecordAudioAuthorizationStatus();
    } else if (Platform.OS === 'android') {
      ...
      hasRecordAudioPermissions =
        await CameraManager.checkMediaCapturePermission();
    }
  }
...
export default class Camera extends React.Component<PropsType, StateType> {
  ...
  static ConversionTables = {
    ...
    faceDetectionClassifications: (CameraManager.FaceDetection || {})
      .Classifications,
    googleVisionBarcodeType: (CameraManager.GoogleVisionBarcodeDetection || {})
      .BarcodeType,
    googleVisionBarcodeMode: (CameraManager.GoogleVisionBarcodeDetection || {})
      .BarcodeMode,
  ...
  static defaultProps: Object = {
    ...
    googleVisionBarcodeType: (
      (CameraManager.GoogleVisionBarcodeDetection || {}).BarcodeType || {}
    ).None,
    googleVisionBarcodeMode: (
      (CameraManager.GoogleVisionBarcodeDetection || {}).BarcodeMode || {}
    ).NORMAL,
    faceDetectionLandmarks: (
      (CameraManager.FaceDetection || {}).Landmarks || {}
    ).none,
    faceDetectionClassifications: (
      (CameraManager.FaceDetection || {}).Classifications || {}
    ).none,
  ...
  getSupportedPreviewFpsRange = async (): Promise<[]> => {
    if (Platform.OS === 'android') {
      return await CameraManager.getSupportedPreviewFpsRange(
        this._cameraHandle,
      );
    } else {
  ...
  async arePermissionsGranted() {
    ...
    const {hasCameraPermissions, hasRecordAudioPermissions} =
      ...
      return (
        <View style={style}>
          <RNCamera
            ...
            onTextRecognized={this._onObjectDetected(
              this.props.onTextRecognized,
            )}
